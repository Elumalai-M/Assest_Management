...
public class AssetController {
	  ...
	  @ApiResponses({
	   ...
	   @RequestMapping(value = "/update", method = RequestMethod.PUT)
	    ...
	    public ResponseEntity<FixedAssetDataResponse> getAssetByid(@PathVariable("assetId") long assetId){
	    	FixedAssetDataResponse assetById = assetService.getAssetById(assetId);
